...
const Pricing = () => {
  ...
  const [iprice, setIprice] = useState(userDetails?.iprice); // {video : 123, photo : 3232}
  const [yprice, setYprice] = useState(userDetails?.yprice);
  ...
  return (
    <div className="container-1">
      ...
      <div className="items">
        <div
          className="item-body"
          style={{ display: formData.iaccountID ? "block" : "none" }}
        >
